<?php
	function logIn($username, $password, $ip) {
		...
		$lockoutString = "SELECT * FROM tbl_user WHERE user_name = '$username' OR user_pass = '$password'"; //check for matching username and password
		...
		if(mysqli_num_rows($user_set)) {
			...
			$message = "Woops! Wrong username/password";
			return $message;
